...
def gradient_descent_runner(points, starting_b, starting_m, starting_c, learning_rate, num_iterations):
    b = starting_b
    m = starting_m
    c = starting_c
...
def run():
    ...
    print("Running...")
    [b, m, c] = gradient_descent_runner(points, initial_b, initial_m, initial_c, learning_rate, num_iterations)
